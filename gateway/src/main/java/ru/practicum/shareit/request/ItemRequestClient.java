...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(Integer userId, ItemRequestDescDto description) {
    ...
    public ResponseEntity<Object> getOtherUsersRequests(Integer userId, int from, int size) {
